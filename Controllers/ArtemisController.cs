...
namespace Consumer.Controllers
{
    ...
    {
        private string _consumerName = "artemis";

        public ArtemisController(ILogger<ArtemisController> logger, IHttpClientFactory httpClientFactory, IConfiguration configuration, IWebhookSecretStore secretStore = null, IConsumerStatusStore statusStore = null) : base(logger, httpClientFactory, configuration, secretStore, statusStore)
        {
        }
