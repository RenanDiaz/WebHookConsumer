...
namespace Consumer.Controllers
{
    ...
    {
        private string _consumerName = "town";

        public TownController(ILogger<TownController> logger, IHttpClientFactory httpClientFactory, IConfiguration configuration, IWebhookSecretStore secretStore = null, IConsumerStatusStore statusStore = null) : base(logger, httpClientFactory, configuration, secretStore, statusStore)
        {
        }
