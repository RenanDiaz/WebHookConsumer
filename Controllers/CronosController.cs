...
namespace Consumer.Controllers
{
    ...
    {
        private string _consumerName = "cronos";

        public CronosController(ILogger<CronosController> logger, IHttpClientFactory httpClientFactory, IConfiguration configuration, IWebhookSecretStore secretStore = null, IConsumerStatusStore statusStore = null) : base(logger, httpClientFactory, configuration, secretStore, statusStore)
        {
        }
